...
describe('Mckinsey Workstream create multiple segments', { tags: "mckinsey" }, function () {
    let authToken,
        testData,
        userDetails
    ...
    it('should create update the Mckinsey project and create one workstream', function () {
        ...
        projectData.workstream_name = 'Test'
        projectData.mckinsey_workstream_id = null
        ...
        projectDetailsPage.getProjectSegments().should('have.length', 2)
    })
})

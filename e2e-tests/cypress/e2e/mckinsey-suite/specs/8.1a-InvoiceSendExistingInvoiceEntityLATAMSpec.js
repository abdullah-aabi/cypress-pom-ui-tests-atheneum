...
describe('Mckinsey receiving invoice', { tags: "mckinsey" }, function () {
    ...
    const projectData = {
        ...
        project_location: {
            address: "Regus Santo Domingo, Robel Corporate Center, 7th Floor, Suits 703 & 706, Rafael Augusto Sanchez No. 86, Piantini, Santo Domingo, Dominican Republic",
            country: "Dominican Republic",
            name: "McKinsey & Company Dominican Republic"
        },
    ...
    it('should check that accounting can create the bundle and send the invoice details to ENS', function () {
        ...
        invoicePage.getSelectInvoicingEntity().click().type("McKinsey & Company Dominican Republic")
        cy.wait(500)
        ...
        cy.wait('@postCAPICreatePlatformInvoice').its('response').then(postInvoiceResponse => {
            ...
            invoicePage.getInvoicingEntity().should('contain.text', 'McKinsey & Company Dominican Republic')

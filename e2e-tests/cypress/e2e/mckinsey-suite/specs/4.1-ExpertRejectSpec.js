...
describe('Associate submitting Experts to a Mckinsey Project', { tags: "mckinsey" }, function () {
    ...
    it('should check Rejected status is set when Mckinsey rejects the expert', function () {
        ...
        cy.postMckinseyExpertReject(projectData)
        cy.checkEPLStatusForCapi(expertData.originalName, 'Expert Rejected')
    })
})
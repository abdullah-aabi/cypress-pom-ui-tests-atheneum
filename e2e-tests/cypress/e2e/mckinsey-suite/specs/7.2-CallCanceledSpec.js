...
describe('Mckinsey canceling calls from API', { tags: "mckinsey" }, function () {
    ...
    it('should cancel a scheduled call, create a call update and reply to ENS', function () {
        ...
        cy.postMckinseyCallCanceled(projectData).then(response => {
            cy.checkEPLStatusForCapi(expertData.originalName, 'Canceled')
